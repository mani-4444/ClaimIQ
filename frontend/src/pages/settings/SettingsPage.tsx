      ...
      <div className="max-w-2xl space-y-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <label key={pref.key} className="flex items-center justify-between py-2 cursor-pointer">
                ...
                <input type="checkbox" defaultChecked className="rounded border-dark-500 bg-dark-700 text-primary-500 focus:ring-primary-500/20 h-4 w-4" />
              </label>
            ))}
          </div>
        </Card>
        ...
        <Card padding="md">
          ...
          <div className="space-y-4">
            ...
            <Input label="New Password" type="password" placeholder="••••••••" hint="Must be at least 8 characters" />
            <Input label="Confirm New Password" type="password" placeholder="••••••••" />
          </div>
          <div className="flex justify-end mt-4">
            <Button variant="secondary" icon={<Lock className="h-4 w-4" />}>Update Password</Button>
          </div>
        </Card>
      </div>
    </div>
