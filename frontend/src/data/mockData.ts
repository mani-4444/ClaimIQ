    ...
    notes: [
      {
        ...
        authorRole: 'adjuster',
        content: 'All documents verified. Damage is consistent with the reported incident.',
      ...
      },
      {
        ...
        author: 'Sarah Johnson',
        authorRole: 'adjuster',
        content: 'Claim approved. Payment will be processed within 5 business days.',
    ...
    notes: [
      {
        ...
        authorRole: 'adjuster',
        content: 'Reviewing plumber invoice and damage documentation. May need on-site inspection.',
    ...
    notes: [
      {
        ...
        author: 'Sarah Johnson',
        authorRole: 'adjuster',
        content: 'Need X-ray report and doctor\'s note. Please upload additional documents.',
    ...
    notes: [
      {
        ...
        author: 'Michael Smith',
        authorRole: 'adjuster',
        content: 'High risk score detected. Flagging for SIU investigation. Multiple inconsistencies in the timeline.',
    ...
    notes: [
      {
        ...
        author: 'Sarah Johnson',
        authorRole: 'adjuster',
        content: 'Inspection reveals pre-existing damage not covered under current policy terms. Claim denied.',
