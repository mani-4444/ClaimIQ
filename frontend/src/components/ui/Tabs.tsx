...
export function Tabs({ tabs, activeTab, onChange, className }: TabsProps) {
  ...
  return (
    <div className={cn('border-b border-white/[0.06]', className)} role="tablist">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex items-center gap-2 whitespace-nowrap border-b-2 px-1 py-3 text-sm font-medium transition-all',
                isActive
